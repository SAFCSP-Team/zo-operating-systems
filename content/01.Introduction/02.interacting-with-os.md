...
As users, we can interact with the operating system through the Graphical User Interface **GUI** or using the Command Line Interface **CLI**. However, software programs communicate with the operating system using System Calls, aka **syscalls**. Syscalls are the services provided by the operating system to manage resources such as processes, memory, files, and much more. As programmers, we develop software programs. Therefore, we need to understand how to interact with the operating system through the use of syscalls in the development phase of a program. 
...
## Program Life-Cycle
We are aiming to understand operating systems from the programmer's perspective. Hence, we are required to understand the phases our programs go through and how operating systems interact and manage them.
